...
describe('resolveBreakpointPayload', () => {
  ...
  const sdk602BreakpointTaskDef = {
    ...
    taskId: 'final-accept',
    invocationKey:
      'smartsamal-deputy-upgrade-golive:final-accept.default.c7a8c6d8add5.0:final-accept',
    ...
    metadata: null,
    breakpoint: {
      breakpointId: 'smartsamal.upgrade.final-accept',
      expert: 'owner',
      options: ['Accept', 'Request changes'],
      question:
        'Accept the upgrade branch + runbooks + report? Nothing was pushed; the Gidon hand-off (push/PR) and the live steps (2-org probe, staging dry-run, PITR drill) remain owner actions listed in the report.',
