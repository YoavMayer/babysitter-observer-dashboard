...
export function SettingsModal({ open, onClose }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50" data-testid="settings-modal" onClick={onClose}>
      <div className="fixed inset-0 bg-black/60" />
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div
          className="relative z-50 rounded-lg border border-border bg-card shadow-xl w-full max-w-lg max-h-[80vh] flex flex-col"
            ...
            {fetchLoading ? (
              ...
              <div className="space-y-5">
                ...
                <section>
                      ...
                      >
                        <div className="flex items-start gap-2">
                          ...
                          <button
                            ...
                            className="mt-4 rounded-md p-1.5 text-foreground-muted hover:text-error hover:bg-error/10 transition-colors"
                            title="Remove source"
                          >
                  ...
                  <button
                    onClick={addSource}
                    className="mt-2 flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs text-foreground-muted hover:text-foreground hover:bg-background-secondary transition-colors"
                  >
                  ...
                  <div className="flex rounded-md border border-border overflow-hidden">
                    {(["dark", "light"] as const).map((t) => (
                      <button
                        ...
                        className={cn(
                          "flex-1 px-4 py-1.5 text-xs font-medium transition-colors capitalize",
                          selectedTheme === t
            ...
            <div className="flex items-center justify-between border-t border-border px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={saving}
                  className="rounded-md px-3 py-1.5 text-xs text-foreground-muted hover:text-foreground hover:bg-background-secondary transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
